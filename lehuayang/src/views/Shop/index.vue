<template>
    <div class="container" style="padding-top: 10px;background-color:#fff;"
        ...
        <div class="serchcont">
            <input type="text" @focus="toserch" placeholder="商户搜索" />
            <div class="serchimg">
...
<script>
    ...
    export default {
        ...
        data() {
            return {
                footobj:[
                    {val:'首页',icon:'icon-shouye',color:'rgb(50,50,50)'},
                    {val:'商城',icon:'icon-shop',color:'rgb(255,131,21)'},
        ...
        methods: {
            ...
            toserch(){
                this.$router.push({path:'/serchShop'})
            },
            undernavfn(item){
